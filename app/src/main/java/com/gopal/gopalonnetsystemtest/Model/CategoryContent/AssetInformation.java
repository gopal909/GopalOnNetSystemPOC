...
public class AssetInformation {
    ...
    @Expose
    private Object assetSearchTags;
    ...
    @Expose
    private List<SubtitleInformation> subtitleInformation = null;
    ...
    @Expose
    private List<BannerUrl> bannerUrl = null;
    ...
    public Object getAssetSearchTags() {
        return assetSearchTags;
    }

    public void setAssetSearchTags(Object assetSearchTags) {
    ...
    public List<SubtitleInformation> getSubtitleInformation() {
        return subtitleInformation;
    }

    public void setSubtitleInformation(List<SubtitleInformation> subtitleInformation) {
    ...
    public List<BannerUrl> getBannerUrl() {
        return bannerUrl;
    }

    public void setBannerUrl(List<BannerUrl> bannerUrl) {
